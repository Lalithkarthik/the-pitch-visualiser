...
def refine_clauses(clauses):
    ...
    for clause in clauses:
        ...
        if not clause:
            continue
        words = clause.split()
        # merge tiny fragments, here treshold is set as 4, can be modified
...
def enforce_scene_limits(scenes, min_scenes=3, max_scenes=7):
    ...
    """
    # too few scenes leads to splitting the longest scene
    ...
    # too many scenes leads to merging relevant adjacent scenes
